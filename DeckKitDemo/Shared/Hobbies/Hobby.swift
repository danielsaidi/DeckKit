...
extension Hobby {
    ...
    static var demoCollection: [Hobby] {
        [
            Hobby(name: "Drawing", text: "Perfect for when you have a lot of paper.", imageName: "pencil", color: .white),
            Hobby(name: "Origami", text: "Perfect for when you have a lot of failed drawings.", imageName: "doc", color: .purple),
            ...
            Hobby(name: "Trashbinning", text: "Realise that the story of your life isn't that exciting.", imageName: "trash", color: .orange),
            Hobby(name: "Studying", text: "Make something out of your life...perhaps it will become exciting?", imageName: "graduationcap", color: .pink),
            Hobby(name: "Macgyvering", text: "Create space rockets out of paperclips. Now THAT'S exciting!", imageName: "paperclip", color: .gray),
            ...
            Hobby(name: "Star gazing", text: "Perfect for when you fail to do the sleeping hobby thing!", imageName: "star", color: .yellow),
            ...
            Hobby(name: "Tornado gazing", text: "Make sure to stay extra far away! And close that umbrella!", imageName: "cloud.bolt", color: .gray),
            Hobby(name: "Pyromaniac stuff", text: "No one should ever claim that this is a hobby. It's illegal!!!", imageName: "flame", color: .red ),
